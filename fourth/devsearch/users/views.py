...
def profiles(request):
    prof, search_query = utils.search_profiles(request)

    custom_range, prof = utils.paginate_profiles(request, prof, 3)
...
def create_message(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'message was send success')
